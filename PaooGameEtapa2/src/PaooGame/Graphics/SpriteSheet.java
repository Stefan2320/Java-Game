...
public class SpriteSheet
{
     ...
     */
    public BufferedImage crop(int x, int y,int z)
    {
        ...
        if(z == 1) {
            ...
            return spriteSheet.getSubimage(x * 20, y * 20, 20, 20);
        else
            return spriteSheet.getSubimage( 0,  0, 319, 319);
    }
}
